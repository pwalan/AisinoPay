  ...
  <body>
    ...
    <nav class="navbar navbar-default" role="navigation">
				<div class="navbar-header">
					 ...
					 <a class="navbar-brand" href="#"><img src="photo/logo.png" class="logo_photo" width="80%" height="150%" alt=""/></a>
				</div>
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						...
						<li class="dropdown_3">
							 <a href="#" class="dropdown-toggle" data-toggle="dropdown">新闻中心<strong class="caret"></strong></a>
							<ul class="dropdown-menu">
								<li>
									 <a href="#">业务动态</a>
								</li>
						...
						<li style="margin:5px 0px 5px 40px">
							<img src="photo/QQlogo.png" width="100%">
						</li>
						<li style="margin:5px 0px">
							<img src="photo/wechatlogo.png" width="100%">
						</li>
					</ul>
