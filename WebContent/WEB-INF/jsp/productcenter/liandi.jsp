				...
				<div class="col-md-9 col-xs-9 column"
					...
					<ul id="myTab" class="nav nav-tabs" style="margin-top: 20px;">
						<li class="active"><a href="#standard" data-toggle="tab">
								E530台式热敏POS </a></li>
						<li><a href="#handin" data-toggle="tab">E550无线POS</a></li>
						<li><a href="#precard" data-toggle="tab">M35 mPOS</a></li>
						<li><a href="#hahaha" data-toggle="tab">E520 MIS POS</a></li>
					</ul>
					<!-- 4个tab页面 -->
					<div id="myTabContent" class="tab-content">
						
						<div class="tab-pane fade in active" id="standard">
							<jsp:include page="liandi_E530.jsp"></jsp:include>
						</div>

						
						<div class="tab-pane fade" id="handin">
							<jsp:include page="liandi_E550.jsp"></jsp:include>
						</div>

						
						<div class="tab-pane fade" id="precard">
							<jsp:include page="liandi_M35.jsp"></jsp:include>
						</div>
						
						<div class="tab-pane fade" id="hahaha">
							<jsp:include page="liandi_E520.jsp"></jsp:include>
						</div>
					</div>
