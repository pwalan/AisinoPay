         ...
         <tr>
            ...
            <div id="docproductSub" style="position:relative;height:100%;">
                   <div class="title_airpay" style="margin-top:10px;">
                     <span id="font_docDownload_E520" style="cursor:pointer;color:#017cfe;" onClick="e520DocDownLoad()"> 文档下载 </span>
                     <span>&nbsp;&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp;</span>
                     <span id="font_productShow_E520" style="cursor:pointer;color:grey;" onClick="e520ProductShow()">产品介绍 </span>
                   </div>
                  ...
                  <div id="e520_filename" class="download_filename" style="margin-top:85px;" onClick="e520_download_func()">
                      E520.pdf        
                  </div>
                   ...
                   <div class="download_cmd" style="margin-top:75px;">
                         <img alt="下载文档" src="img/t8/download.jpg" onClick="e520_download_func()">
                  </div>
                         ...
                         <div style="position:absolute;width:120px;margin-top:35px;margin-left:120px;" >
                          ...
                          <div class="productdespDiv">
                             <font style="line-height:1.5;letter-spacing:1px;">
                               E520是基于新一代电子支付核心技术统一平台UNIMARS II开发的系列POS（销售点终端）产品。终端经过多种认证保证您的交易安全。它们基于一致的软件、硬件、工业设计，外观新颖，功能强大，带大容量内存，大屏幕显示液晶，可读写SAM卡、IC卡，支持ISO/IBM格式磁卡，集成高速打印机，可选多种远程通讯模块。支持多应用程序管理，提供应用程序集成开发工具。通过了国际或国内PBOC 3.0、PCI PTS 3.X、EMV、银联直联入网认证、3C认证、电信设备进网许可认证等等，适合用于银行网点、商场、酒店、餐饮服务业等各种需要电子交易的场所。
                             </font>                        
                          </div>                  
...
<form id="myForm_e520"  method="POST">
