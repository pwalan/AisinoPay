...
<script type="text/javascript">
	function e530ProductShow() {
		document.getElementById('product_module_E530').style.display = "block";
		document.getElementById('document_module_E530').style.display = "none";
		document.getElementById('font_productShow_E530').style.color = '#017cfe';
		document.getElementById('font_docDownload_E530').style.color = 'grey';
		/*
	...
	function e530DocDownLoad() {
		document.getElementById('document_module_E530').style.display = "block";
		document.getElementById('product_module_E530').style.display = "none";
		document.getElementById('font_docDownload_E530').style.color = '#017cfe';
		document.getElementById('font_productShow_E530').style.color = 'grey';
		/*
		if(window.screen.width<1280)
		{
		 setElementHeight('subDiv_docProduct','218px');
	...
	window.onload = function() {
		...
		if (isFireFox() || isIE6() || isIE7() || isIE8() || isIE9() || isIE10()) {
			document.getElementById('docproductSub').style.marginTop = (-100)
					+ 'px';
			document.getElementById('featureSub').style.marginTop = (-425)
					+ 'px';
			document.getElementById('ruleSub').style.marginTop = (-510) + 'px';
		}
		if (isIE7()) {
		...
		//窄屏时
		 if(window.screen.width<1280)  
		 {
		   ...
		   setElementHeight('subDiv_rule','920px');     
		   ...
		   replaceStyle('list_left even','fontSize','12px');
		    ...
		    {
		    setElementMarginTop('ruleSub','-450px');
		    }   
		    //标题栏的线
...
<body bgcolor="#faf8f3">
				...
				<td>
					<div id="docproductSub" style="position: relative; height: 100%;">
						<div class="title_airpay" style="margin-top: 10px;">
							<span id="font_docDownload_E530"
								style="cursor: pointer; color: #017cfe;"
								onClick="e530DocDownLoad()"> 文档下载 </span> <span>&nbsp;&nbsp;&nbsp;
								| &nbsp;&nbsp;&nbsp;</span> <span id="font_productShow_E530"
								style="cursor: pointer; color: grey;"
								onClick="e530ProductShow()">产品介绍 </span>
						</div>
						...
						<div id="document_module_E530" style="display: block;">
							...
							<div id="e530_filename" class="download_filename"
                         ...
                         10863K 
							...
							<div class="" style="margin-top: 20px;">
								...
								<p align="right" style="margin-top: 95px; margin-right: 25px">10863K</p>
							</div>
						...
						<div id="product_module_E530" style="display: none;">
							...
							<div class="productdespDiv">
								<font style="line-height: 1.5; letter-spacing: 1px;">
									E530是基于新一代电子支付核心技术统一平台UNIMARS
									II开发的系列POS(销售点终端)产品。终端经过多种认证保证您的交易安全。它们基于一致的软件、硬件、工业设计，外观新颖，功能强大，带大容量内存，大屏幕显示液晶，可读写SAM卡、IC卡，支持ISO/IBM格式磁卡，集成高速打印机，可选多种远程通讯模块。支持多应用程序管理，提供应用程序集成开发工具。通过了国际或国内PBOC3.0、PCI
									PTS3.X、EMV、银联直联入网认证、3C认证、电信设备进网许可认证等等，适合用于银行网点、商场、酒店、餐饮服务业等各种需要电子交易的场所。
								</font>
				...
				<td>
					<div id="featureSub" style="position: relative; height: 100%;">
						...
						<div
							...
							<img id="featurebannnerImg" src="img/liandi/E530/pos.png"
								width="100%" style="margin-left: 5px">
						</div>

						<div class="col-md-12 col-xs-12" style="margin-top: 330px;">
							<div class="col-md-2 col-xs-2">
								<img src="img/liandi/E530/1.png" width="100%">
							</div>
							...
							<div class="col-md-2 col-xs-2">
								<img src="img/liandi/E530/8.png" width="100%">
							</div>
							<div class="col-md-4 col-xs-4">
								<div class="contentlist_title">安全性</div>
								<div class="contentlist_desc">按PCI
									3.X最高安全标准设计，多项措施保障金融交易的安全</div>
							</div>
						</div>
						<div class="col-md-12 col-xs-12" style="margin-top: 20px;">
							<div class="col-md-2 col-xs-2">
								<img src="img/liandi/E530/2.png" width="100%">
							</div>
							<div class="col-md-4 col-xs-4">
							...
							<div class="col-md-2 col-xs-2">
								<img src="img/liandi/E530/3.png" width="100%">
							</div>
							<div class="col-md-4 col-xs-4">
						...
						<div class="col-md-12 col-xs-12"
							...
							<div class="col-md-2 col-xs-2">
								<img src="img/liandi/E530/4.png" width="100%">
							</div>
							<div class="col-md-4 col-xs-4">
							...
							<div class="col-md-2 col-xs-2">
								<img src="img/liandi/E530/5.png" width="100%">
							</div>
						...
						<div class="col-md-12 col-xs-12"
							style="margin-top: 20px; margin-bottom: 20px;">
							<div class="col-md-2 col-xs-2">
								<img src="img/liandi/E530/6.png" width="100%">
							</div>
							<div class="col-md-4 col-xs-4">
	...
	<form id="myForm_e530" name="myForm" method="POST"></form>
</body>
</html>