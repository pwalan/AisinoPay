...
<body bgcolor="#faf8f3">
	...
	<div style="margin-top: 10px;">
		<img src="img/liandi/E550/e550.jpg" width="100%" height="100%">
	</div>
	<!-- 文档下载模块 -->
				...
				<td>
					<div id="docproductSub" style="position: relative; height: 100%;">
						<div class="title_airpay" style="margin-top: 10px;">
							<span id="font_docDownload_E550"
								style="cursor: pointer; color: #017cfe;"
								onClick="e550DocDownLoad()"> 文档下载 </span> <span>&nbsp;&nbsp;&nbsp;
								| &nbsp;&nbsp;&nbsp;</span> <span id="font_productShow_E550"
								style="cursor: pointer; color: grey;"
								onClick="e550ProductShow()">产品介绍 </span>
						</div>
						...
						<div id="document_module_E550" style="display: block;">
							...
							<div id="e550_filename" class="download_filename"
                         ...
                         10880K 
							...
							<div class="" style="margin-top: 20px;">
								...
								<p align="right" style="margin-top: 95px; margin-right: 25px">10880K</p>
							</div>
						...
						<div id="product_module_E550" style="display: none;">
							...
							<div class="productdespDiv">
								<font style="line-height: 1.5; letter-spacing: 1px;">
									E550是基于新一代电子支付核心技术统一平台UNIMARS
									II开发的系列POS(销售点终端)产品。终端经过多种认证保证您的交易安全。它们基于一致的软件、硬件、工业设计，外观新颖，功能强大，带大容量内存，大屏幕显示液晶，可读写SAM卡、IC卡，支持ISO/IBM格式磁卡，集成高速打印机，可选多种远程通讯模块。支持多用于程序管理，提供应用程序集成开发工具。通过了国际或国内PBOC3.0、PCI
				...
				<td>
					<div id="featureSub" style="position: relative; height: 100%;">
						...
						<div
							...
							<img id="featurebannnerImg" src="img/liandi/E550/pos.jpg"
						...
						<div
							...
							<table>
								...
								<tr>
									...
									<td class="list_mid"></td>
									<td class="list_right even"><font class="list_right_font">
											19键 <font class="list_right_font"></td>
								</tr>
								<tr>
								...
								<tr>
									...
									</font> <font class="list_right_font"> 可选WCDMA/EVDO等3G通信<br>
	...
	<form id="myForm_e550" method="POST"></form>
</body>
</html>