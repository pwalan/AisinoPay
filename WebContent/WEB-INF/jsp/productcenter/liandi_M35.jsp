...
<script type="text/javascript">
	function m35ProductShow() {
		...
		if (isFireFox() || isIE6() || isIE7() || isIE8() || isIE9() || isIE10()) {
			document.getElementById('docproductSub').style.marginTop = (-63)
					+ 'px';
		}
	}
	function m35DocDownLoad() {
		...
		//if(navigator.userAgent.indexOf('Firefox')>0 && window.screen.width<1280)
		if (isFireFox() || isIE6() || isIE7() || isIE8() || isIE9() || isIE10()) {
			document.getElementById('docproductSub').style.marginTop = (-170)
					+ 'px';
		}
	}
...
<body bgcolor="#faf8f3">
				...
				<td>
					<div id="docproductSub" style="position: relative; height: 100%;">
						<div class="title_airpay" style="margin-top: 10px;">
							<span id="font_docDownload_M35"
								style="cursor: pointer; color: #017cfe;"
								onClick="m35DocDownLoad()"> 文档下载 </span> <span>&nbsp;&nbsp;&nbsp;
								|&nbsp;&nbsp;&nbsp;</span> <span id="font_productShow_M35"
								style="cursor: pointer; color: grey;" onClick="m35ProductShow()">产品介绍
							</span>
						</div>
						...
						<div id="document_module_M35" style="display: block;">
							...
							<div id="m35_filename1" class="download_filename"
								style="margin-top: 85px;" onClick="m35_download1_func()">
								M35.pdf</div>
							...
							<div class="" style="">
								<img src="img/t8/download.jpg" onClick="m35_download1_func()"
									align="right" style="margin-top: 75px; margin-right: 20px"><br />
								<br />
								<p align="right" style="margin-top: 95px; margin-right: 25px">1146K</p>
							</div>
							...
							<!-- 第二条下载列表 -->
							<div class="download_pdfimg" style="margin-top: 80px;">
								<img src="img/liandi/M35/pdf2.png" width="98" height="108">
							</div>
							<div id="m35_filename2" class="download_filename"
								style="margin-top: 95px;" onClick="m35_download2_func()">
								M35 Compatible List.pdf</div>
							<!-- <div class="download_hline" stylee="margin-top: 255px;">
								<hr class="download_hline_inner">
							</div> -->
							<div class="download_time" style="margin-top: 135px;">
								上传时间：2015-03-16 13:15</div>
                         ...
                         735K 
							...
							<div class="">
								<img alt="下载文档" src="img/t8/download.jpg"
									onClick="m35_download2_func()" align="right"
									style="margin-top: 95px; margin-right: 20px"> <br /> <br />
								<p align="right" style="margin-top: 105px; margin-right: 25px">735K</p>
							</div>
							<div id="vline2" class="download_vline"
				...
				<td>
					<div id="featureSub" style="position: relative; height: 100%;">
						...
						<div
							...
							<img id="featurebannnerImg" src="img/liandi/M35/pos.png"
						...
						<div class="contentlist_left" style="margin-top: 455px;">
							<div style="margin-top: 38px;">兼容主流IOS、Android(TM)智能设备</div>
						</div>
						<div class="contentlist_left" style="margin-top: 580px;">
							<div style="margin-top: 28px;">可选蓝牙，摆脱线缆的束缚，支付体验更好</div>
						</div>
						...
						<div class="contentlist_right" style="margin-top: 330px;">
							<div style="margin-top: 28px;">EMV Level 1 & 2、PCI PTS 3.x
								& SRED认证</div>
						</div>
						<div class="contentlist_right" style="margin-top: 455px;">
							<div style="margin-top: 28px;">采用音频线分离设计，方便商户使用已有的手机和平板电脑</div>
						</div> -->
						...
						<div
							...
							<table>
								...
								<tr>
									...
									<td class="list_right odd"><font class="list_right_font">
											128*64像素点阵液晶<br>
									</font> <font class="list_right_font"> LED白色背光 </font></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td class="list_mid"></td>
									<td class="list_right even"><font class="list_right_font">
											支持ISO/IEC 14443 Type A&B卡 </font></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td class="list_right odd"><font class="list_right_font">
											3.5mm耳机孔音频通讯<br>
									</font> <font class="list_right_font"> Micro USB<br>
									</font> <font class="list_right_font"> 蓝牙4.0 </font></td>
								</tr>
	...
	<form id="myForm_m35" name="myForm" method="POST"></form>
</body>
</html>